...
try {
    ...
    // We are going to construct a string of JS code, write it, and let node run it.
    const code = `
const fs = require('fs');
...
`;
    ...
    fs.writeFileSync('extractor.cjs', code);
    console.log("Extractor written to extractor.cjs");
} catch (e) {
    console.error("err:", e);
}
