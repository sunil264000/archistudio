              ...
              <CardContent className="pt-4 space-y-4">
                <div className="flex gap-2">
                  {socialLinks.instagram_url && (
                    <a href={socialLinks.instagram_url} target="_blank" rel="noopener noreferrer" className="flex-1">
                  ...
                  {socialLinks.telegram_url && (
                    <a href={socialLinks.telegram_url} target="_blank" rel="noopener noreferrer" className="flex-1">
                ...
                {(!socialLinks.instagram_url && !socialLinks.telegram_url) && (
                  <p className="text-xs text-muted-foreground text-center">Social links coming soon!</p>
                )}
