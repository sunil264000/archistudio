...
export const InviteEmail = ({ siteName, siteUrl, confirmationUrl }: InviteEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to join Archistudio</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          ...
          <Text style={text}>
            You've been invited to join <Link href={siteUrl} style={link}><strong>{siteName}</strong></Link>. Accept below to create your account and start learning.
          </Text>
